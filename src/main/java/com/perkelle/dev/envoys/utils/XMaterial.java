...
public enum XMaterial {
     ...
     * @since 2.0.0
     */
    public static boolean containsLegacy(@NotNull String name) {
     ...
     * @since 2.0.0
     */
    public static boolean isVersionOrHigher(@NotNull MinecraftVersion version) {
     ...
     */
    @NotNull
    public static MinecraftVersion valueOfVersion(@NotNull String version) {
    ...
    public ItemStack setType(@NotNull ItemStack item) {
        ...
        item.setType(Objects.requireNonNull(this.parseMaterial()));
     ...
     * @since 2.0.0
     */
    public boolean anyMatchLegacy(@NotNull String name) {
